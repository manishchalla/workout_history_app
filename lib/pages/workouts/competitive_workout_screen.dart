    ...
    try {
      ...
      if (byteData != null) {
        ...
        await Share.shareXFiles(
          [XFile(file.path)],
          text: 'Join my competitive workout with code: $_inviteCode',
        );
      }
    } catch (e) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Icon(Icons.group_add, color: Colors.orangeAccent),
                            SizedBox(width: 8),
                            Text(
                              'Invite Friends',
                        ...
                        ...participants.entries.map((entry) {
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              backgroundColor: isCreator ? Colors.orange : Colors.grey[300],
                              child: Icon(
                            ...
                            title: Text(
                              isCreator ? (userId == _firestoreService.currentUserId ? "You (Host)" : "Host")
                                  : (userId == _firestoreService.currentUserId ? "You" : "Participant"),
                              style: TextStyle(
